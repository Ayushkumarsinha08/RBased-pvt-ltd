...
export default function Login() {
  ...
  return (   
    ...
    <div className="h-screen flex justify-center items-center">
      <div className="bg-gradient-to-b from-gray-950 h-180 w-150 rounded-2xl flex justify-center items-center overflow-hidden shadow-lg transition-transform hover:scale-105 border-2 border-white/20">
